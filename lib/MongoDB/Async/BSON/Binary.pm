...
{
  $MongoDB::Async::BSON::Binary::VERSION = '0.503.2';
}
...
has subtype => (
    ...
    isa => 'Int',
    required => 0,
    default => MongoDB::Async::BSON::Binary->SUBTYPE_GENERIC
);
...
MongoDB::Async::BSON::Binary - A type that can be used to send binary data to the
database
